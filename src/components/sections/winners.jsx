        ...
        >
          <div className="bg-slate-900/80 backdrop-blur-sm border border-slate-800 rounded-3xl p-8 hover:border-blue-500/30 hover:glow-blue transition-all duration-300">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              >
                <div
                  className={`w-32 h-32 rounded-full bg-gradient-to-br ${rankColors[featuredWinner.rank]} flex items-center justify-center glow-blue`}
                >
          ...
          {otherWinners.map((winner) => (
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-br ${rankColors[winner.rank]} flex items-center justify-center`}
                >
                  <Trophy className="w-6 h-6 text-white" />
                </div>
                <Badge className={rankBadges[winner.rank]}>{winner.rank}</Badge>
              </div>
